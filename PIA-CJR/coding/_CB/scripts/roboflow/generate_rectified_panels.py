# ============================================================
# FILE: scripts/roboflow/2_generate_rectified_panels.py
# ============================================================
...
def main():
    ...
    # best_pt = YOLO_PROJECT_DIR / YOLO_BEST_PT
    # model = YOLO(best_pt)
    ...
    OUTPUT_DIR = config["RECTIFIED_PANELS_DIR"]
    ...
    for image_path in input_dir.rglob("*"):
        ...
        for r in results:
            ...
            for mask in masks:
                ...
                output_path = os.path.join(OUTPUT_DIR, f"panel_{panel_id:05d}.png")
    ...
    print(f"\nConcluído! {panel_id} painéis gerados.")
