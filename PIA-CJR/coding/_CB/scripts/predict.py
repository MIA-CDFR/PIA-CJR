...
# Default RAW_RECTIFIED_PANELS_DIR from config.yaml
# 
...
def main():
    ...
    if args.input is None:
        ...
        input_path = Path(config["RAW_RECTIFIED_PANELS_DIR"])        
    ...
    prediction_run_name = f"predict_" f"{model_name}_" f"{timestamp}"
