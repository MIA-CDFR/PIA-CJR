...
def compute_metrics(y_true, y_pred, y_prob=None):
    ...
    metrics = {
        ...
        # CLASS METRICS
        # ====================================================
        "precision_non_defect": precision_score(
            y_true, y_pred, pos_label=0, zero_division=0
        ),
        "recall_non_defect": recall_score(y_true, y_pred, pos_label=0, zero_division=0),
        "f1_non_defect": f1_score(y_true, y_pred, pos_label=0, zero_division=0),
